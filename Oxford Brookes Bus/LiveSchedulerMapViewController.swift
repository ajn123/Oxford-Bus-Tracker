...
class LiveSchedulerMapViewController: UIViewController, MKMapViewDelegate, CLLocationManagerDelegate {
  ...
  override func viewDidLoad() {
    ...
    let vConstraint1 = NSLayoutConstraint.constraintsWithVisualFormat("V:|[map]|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewDict)
    
    let hConstraint1 = NSLayoutConstraint.constraintsWithVisualFormat("H:|[map]|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: viewDict)
  ...
  {
     // TODO: show live lists of stop when clicked
  }
